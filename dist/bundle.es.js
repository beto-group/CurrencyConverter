(function(){"use strict";try{if(typeof document<"u"){var e=document.createElement("style");e.appendChild(document.createTextNode(".currency-app{font-family:Inter,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,sans-serif;width:100%;height:100%;min-height:100vh;background:#09090b;color:#fafafa;display:flex;flex-direction:column;align-items:center;justify-content:flex-start;padding:16px;box-sizing:border-box;overflow-y:auto}.glass-card{background:#18181b;border:1px solid #27272a;border-radius:20px;padding:20px;width:100%;max-width:540px;box-shadow:0 20px 40px #0006;display:flex;flex-direction:column;gap:16px;position:relative;box-sizing:border-box;margin:0 auto}@media (max-width: 600px){.currency-app{padding:10px}.glass-card{max-width:100%;border-radius:16px;padding:16px;gap:14px}}.currency-title{font-size:clamp(1.1rem,4vw,1.5rem);font-weight:700;margin:0;color:#fafafa;text-align:left;letter-spacing:-.02em}.status-badge{position:absolute;top:20px;right:20px;font-size:.65rem;text-transform:uppercase;letter-spacing:1px;font-weight:700;padding:4px 8px;border-radius:6px;background:#10b98126;color:#10b981}.status-badge.offline{background:#f59e0b26;color:#f59e0b}.input-group{display:flex;flex-direction:column;gap:6px}.input-group label{font-size:.75rem;color:#a1a1aa;font-weight:500}.input-wrapper{display:flex;align-items:center;background:#09090b;border:1px solid #3f3f46;border-radius:10px;transition:all .2s ease;position:relative;width:100%;box-sizing:border-box}.input-wrapper:focus-within{border-color:#3b82f6;box-shadow:0 0 0 3px #3b82f626}.currency-input{background:transparent;color:#fafafa;border:none;padding:14px;font-size:1.25rem;font-weight:500;width:100%;outline:none;text-align:right;font-variant-numeric:tabular-nums;flex:1;min-width:0}.currency-input::placeholder{color:#52525b}.swap-btn{background:#27272a;border:1px solid #3f3f46;color:#a1a1aa;width:38px;height:38px;border-radius:50%;display:flex;align-items:center;justify-content:center;cursor:pointer;align-self:center;transition:all .2s ease;margin:-6px 0;z-index:2}.swap-btn:hover{background:#3f3f46;color:#fafafa}.sync-btn{background:#fafafa;color:#09090b;border:none;padding:14px;border-radius:10px;font-weight:700;font-size:.9rem;cursor:pointer;transition:all .2s ease}.sync-btn:hover{background:#e4e4e7}.sync-btn:active{transform:scale(.98)}.last-updated{text-align:center;font-size:.75rem;color:#71717a;margin-top:4px}")),document.head.appendChild(e)}}catch(r){console.error("vite-plugin-css-injected-by-js",r)}})();
...
const Fd = ({ children: e }) => /* @__PURE__ */ k.jsx("div", { className: "agent-layer-safe-zone", style: { width: "100%", height: "100%" }, children: e }), Od = {
  ...
  return /* @__PURE__ */ k.jsx(Fd, { children: /* @__PURE__ */ k.jsx("div", { className: "currency-app", ref: r, style: { position: "relative" }, children: /* @__PURE__ */ k.jsxs("div", { className: "glass-card", style: { maxWidth: "460px", margin: "0 auto" }, children: [
